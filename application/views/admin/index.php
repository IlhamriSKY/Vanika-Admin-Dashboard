                            ...
                            <div class="dropdown-menu scale-up-left">
                                <ul class="mega-dropdown-menu row">
                                    <li class="col-lg-3 col-xlg-2 m-b-30">
                                        <h4 class="m-b-20">BIRO</h4>
                                        <!-- CAROUSEL -->
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/mahasiswabaru.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/akademik.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/keuagan.jpg" alt="Third slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/perpustakaan.jpg" alt="Four slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/kemahasiswaan.jpg" alt="Five slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/karir.jpg" alt="Six slide"></div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Test</h5> <span class="mail-desc">Test</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">User Web</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/userweb/add') ?>"><i class="fa fa-angle-right"></i> Add User </a></li>
                                    <li><a href="<?php echo base_url('admin/userweb/power') ?>"><i class="fa fa-angle-right"></i> Add User Power</a></li>
                                <?php else: ?>
                                ...
                                <li><a href="<?php echo base_url('admin/userweb/') ?>"><i class="fa fa-angle-right"></i> All Users</a></li>
                            </ul>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">User Vanika</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/uservanika/userlist') ?>"><i class="fa fa-angle-right"></i> All Users</a></li>
                            </ul>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file-chart"></i><span class="hide-menu">Statistics</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/uservanika/usertext') ?>"><i class="fa fa-angle-right"></i> All User Text</a></li>
                                <li><a href="<?php echo base_url('admin/uservanika/usertext_status/no') ?>"><i class="fa fa-angle-right"></i> UnAnswered User Text</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Command</span></a>
                            <ul aria-expanded="false" class="collapse">

							<?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/uservanika/addcommand') ?>"><i class="fa fa-angle-right"></i> Add Command </a></li>
                                <?php else: ?>
                                    <?php if(check_power(1)):?>
                                        <li><a href="<?php echo base_url('admin/uservanika/addcommand') ?>"><i class="fa fa-angle-right"></i> Add Command </a></li>
                                    <?php endif; ?>
                                ...
                                <li><a href="<?php echo base_url('admin/uservanika/command') ?>"><i class="fa fa-angle-right"></i> All Command</a></li>
